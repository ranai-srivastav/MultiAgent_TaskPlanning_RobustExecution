...
\begin{table}
    ...
    \begin{tabular}{llll}
        ...
        \midrule
        Map 1 & 30, 6/11 & 16, 2/3 & 16, 2/3 \\
        Map 4 & 31, 36/60 & 17, 4/6 & 17, 3/5 \\
        Map 8 & 47, 3118/6004 & 14, 1/1 & 14, 1/1 \\
        \bottomrule
    \end{tabular}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/TPG-Rollout.drawio}
    ...
    Here we can see that the TPG is cylcic and thus, when attempting to resolve this graph into a sequence of actions for each agent,
    we will be not be able to decompose it. Because TPG has a cycle, it ialso is a good exmaple of a deadlock!
