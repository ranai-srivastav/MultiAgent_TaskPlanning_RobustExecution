...
\section*{Task 4 - Running Statistics}
  ...
  \textbf{Mean = 25.16,\ Std.\ Dev.\ = 3.69,\ Variance $\approx$ 13.61}

  \medskip
  \noindent\textbf{Stats on number of generated nodes (12 samples):}\\
  \textbf{Mean = 37.33,\ Std.\ Dev.\ = 56.18,\ Variance $\approx$ 3156.19}
...
\section*{Task 8}
    ...
    The Hungarian algorithm is optimal and complete for a bipartite graph given that an assignment does not cause a change in the graph.
